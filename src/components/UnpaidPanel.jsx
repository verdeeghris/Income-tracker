              ...
              return (
                <li key={item.instanceKey}>
                  <button
                    type="button"
                    onClick={() => onOpen(item)}
                    className="grid w-full grid-cols-[auto_auto_minmax(0,1fr)_auto] items-center gap-2 px-4 py-2 text-left transition-colors hover:bg-stone-50 dark:hover:bg-white/[0.04] sm:px-5"
                  >
                    <span
